...
const products = [
  ...
  },
  {
    ...
    price: 449.00,
    description: 'Fully adjustable mesh chair with lumbar support, armrests, and a 5-year warranty.',
    stock: 20,
    category: 'Furniture',
  ...
  },
  {
    ...
    price: 34.95,
    description: 'Double-wall insulated 32oz bottle — keeps drinks cold for 24 hours, hot for 12.',
    stock: 200,
    category: 'Outdoors',
  ...
  },
  {
    name: 'Yoga Mat',
    price: 59.99,
    description: 'Non-slip 6mm thick mat with carrying strap. Suitable for all levels.',
    stock: 120,
    category: 'Fitness',
  ...
  },
  {
    ...
    price: 89.99,
    description: '7-in-1 hub with 4K HDMI, 100W PD, 3x USB-A, SD card reader, and Gigabit Ethernet.',
    stock: 60,
    category: 'Electronics',
  ...
  },
  {
    ...
    price: 48.00,
    description: 'Handcrafted dripper and carafe set for a clean, precise brew. Dishwasher safe.',
    stock: 35,
    category: 'Kitchen',
  ...
  },
  {
    ...
    price: 14.99,
    description: '200-page dot-grid notebook with lay-flat binding and ribbon bookmark.',
    stock: 300,
    category: 'Stationery',
